...
public class Game extends JFrame implements java.awt.event.ActionListener, KeyListener {

    public static final int GAME_WIDTH = 1200;
    public static final int GAME_HEIGHT = 700;
    private static final int TICK_MS = 16;

    private Paddle paddle = new Paddle(500, 500, 120, 40, 10, 0,
            "img/paddle/paddlevip.png");
    ...
    public Game() {
        ...
        layers.setLayout(null); // absolute
        ...
        layers.add(ballPrinter, Integer.valueOf(10)); // top layer
        ...
        for (int r = 0; r < rows; r++) {
            for (int c = 0; c < cols; c++) {
                ...
                ObjectPrinter p = new ObjectPrinter();
                configurePrinter(p);
                p.setGameObject(b);
                brickPrinters.put(b, p);
                layers.add(p, Integer.valueOf(5)); // below ball
            }
        }
        ...
        bgLabel.setBounds(0, 0, GAME_WIDTH, GAME_HEIGHT);
        layers.add(bgLabel, Integer.valueOf(0));
